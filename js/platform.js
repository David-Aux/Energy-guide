    ...
    function normalizeYearsExperienceValue(value) {
    ...
    function yearsExperienceDbValue(value) {
      const normalized = normalizeYearsExperienceValue(value);
      const map = {
        '0-1': '0',
        '1-3': '2',
        '3-5': '4',
    ...
    function yearsExperienceLabel(value) {
      const normalized = normalizeYearsExperienceValue(value);
      const map = {
      ...
      return map[normalized] || (value == null ? '' : String(value));
    }
    ...
    function renderInstallerProfileView(profile) {
      ...
      content.innerHTML = `
        <div style="background:#fff;border:1px solid #E5E7EB;border-radius:20px;padding:20px;box-shadow:0 8px 24px rgba(0,0,0,0.04);">
          ...
          ${renderProfileField('Years of Experience', displayValue(yearsExperienceLabel(profile.years_experience)))}
    ...
    async function loadInstallerProfileScreen() {
      ...
      set('ipYears', normalizeYearsExperienceValue(profile.years_experience));
    ...
    async function saveInstallerProfile() {
      ...
      try {
        ...
        const payload = {
          ...
          years_experience:   yearsExperienceDbValue(get('ipYears')),
        ...
        return `
            <div class="result-card" style="text-align:left; margin-bottom: 14px;">
              ...
              <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; font-size:14px; line-height:1.5;">
                ...
                <div><span style="color:#687076;">Years of Experience</span><br><strong>${safeText(yearsExperienceLabel(profile.years_experience) || 'Not specified')}</strong></div>
...
async function supabaseSubmitMarketplaceLead(lead) {
  try {
    ...
    async function registerInstaller() {
      ...
      const years = yearsExperienceDbValue(document.getElementById('regInstYears').value);
