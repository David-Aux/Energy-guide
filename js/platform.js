    ...
    function normalizeYearsExperienceForDb(value) {
    ...
    function yearsExperienceOptionValue(value) {
      const dbValue = normalizeYearsExperienceForDb(value);
      const reverseMap = {
        0: '0-1',
        2: '1-3',
        4: '3-5',
    ...
    function formatYearsExperience(value) {
      ...
      if (dbValue in labelMap) return labelMap[dbValue];
    ...
    function renderInstallerProfileView(profile) {
      ...
      content.innerHTML = `
        <div style="background:#fff;border:1px solid #E5E7EB;border-radius:20px;padding:20px;box-shadow:0 8px 24px rgba(0,0,0,0.04);">
          ...
          ${renderProfileField('Years of Experience', displayValue(formatYearsExperience(profile.years_experience)))}
    ...
    async function loadInstallerProfileScreen() {
      ...
      set('ipYears', yearsExperienceOptionValue(profile.years_experience));
    ...
    async function saveInstallerProfile() {
      ...
      try {
        ...
        const payload = {
          ...
          years_experience:   normalizeYearsExperienceForDb(get('ipYears')),
  ...
  try {
    ...
    async function registerInstaller() {
      ...
      const result = await supabaseSignUp(email, password, {
        ...
        market_type: market,
        years_experience: normalizeYearsExperienceForDb(years),
        whatsapp_number: whatsapp,
        cac_number: cac,
        business_description: desc,
        security_q: securityQ,
