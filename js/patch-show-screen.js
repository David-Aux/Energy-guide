(function(){
  function syncVendorBodyClass(screenId){
  ...
  document.addEventListener('click', function(){
    setTimeout(function(){
      ...
      if (active) syncVendorBodyClass(active.id);
    }, 0);
  }, true);
  ...
  window.openInstViewCost = function(){
    ...
    try {
      ...
      showScreen('user-cost-breakdown'); syncVendorBodyClass('user-cost-breakdown');
      ...
      document.querySelectorAll('#user-cost-breakdown button').forEach(btn => {
        ...
        if (t.includes('back')) {
          ...
          btn.onclick = () => { showScreen('installer-calculator'); syncVendorBodyClass('installer-calculator'); forceTop('installer-calculator'); };
        }
      });
  ...
  window.openInstallerQuoteBuilder = function(){
    ...
    try {
      ...
      showScreen('installer-quote-builder'); syncVendorBodyClass('installer-quote-builder');
  ...
  window.openVendorOfferBuilder = function(){
    ...
    try {
      ...
      showScreen('vendor-offer-builder'); syncVendorBodyClass('vendor-offer-builder');
      const stray = document.getElementById('vendorCalcBuildOfferBtn');
